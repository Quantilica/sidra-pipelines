WITH
	DADOS_IPP_CATEGORIA_ECONOMICA AS (
		SELECT
			...
			L.D1N AS LOCALIDADE,
			DIM.D4C AS CATEGORIA_ECONOMICA_ID,
			DIM.D4N AS CATEGORIA_ECONOMICA,
			DIM.D2N AS VARIAVEL,
			DIM.MN AS UNIDADE,
			CASE
